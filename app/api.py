...
app = FastAPI(
    title="MLOps",
    description="MLOps Template for Data Science Projects",
    version="0.1",
)


# Service wont start until artifacts are loaded using app.on_event("startup")
# prevents unforseen errors with artifacts not being loaded
...
# Add relevent metadata to the response using a wrapper
...
# Health check in base directory '/'
...
# Check for performance metrics with an optional filter to get the metrics for a specific model
